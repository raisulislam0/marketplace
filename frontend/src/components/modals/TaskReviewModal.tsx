...
export default function TaskReviewModal({ isOpen, onClose, task, onReview }: TaskReviewModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center rounded-t-lg">
              <h2 className="text-2xl font-bold text-gray-800">Review Task Submission</h2>
              ...
              {task.submission_file && (
                <div className="bg-blue-50 border border-blue-200 rounded p-3">
                  <p className="text-sm text-blue-800">
                    <strong>Submitted file:</strong> {task.submission_file.split('/').pop()}
                  </p>
                </div>
              )}
